...
**File Structure:**
```
prototypes/0.7.0-core-loop-demo/
...
**Implementation Location:** All code implementations will be in `/prototypes/0.7.0-core-loop-demo/` (the highest-versioned core-loop folder is always the live game; superseded versions stay frozen, e.g. `/prototypes/0.6.0-core-loop-demo/`)
