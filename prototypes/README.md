...
| Demo | Description |
|---|---|
| [`0.14.0-core-loop-demo`](0.14.0-core-loop-demo/) | **The game (current release target).** Inherits the room-key-first ticket/always-bridge improvements and incorporates the latest UI/visual cleanup fixes from prior lines. |
...
[`0.14.0-core-loop-demo/src-tauri`](0.14.0-core-loop-demo/src-tauri/) (window, Rust
