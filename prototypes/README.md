...
| Demo | Description |
|---|---|
| [`0.26.0-core-loop-demo`](0.26.0-core-loop-demo/) | **Queued next line** (re-cut from 0.25.0 after its release; carries the issue #60 cross-internet connection fixes — sync-before-enter gate, symmetric peer tick fan-out, eager/retrying mesh dial, and E4 furniture-layout sync — for the `v0.26.0` tag). |
