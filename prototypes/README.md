...
| Demo | Description |
|---|---|
| [`0.17.0-core-loop-demo`](0.17.0-core-loop-demo/) | **The game (current release target).** Cross-machine bridge fix pack: browser reads node-initiated streams (0.16.0 hard blocker), visible bridge dial-status, live invite hints, `ssf://` invite carrier, `SSF_IROH_PORT`/`SSF_EXTERNAL_ADDRS` reachability rungs, mDNS LAN discovery. |
...
[`0.17.0-core-loop-demo/src-tauri`](0.17.0-core-loop-demo/src-tauri/) (window, Rust
