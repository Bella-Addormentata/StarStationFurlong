...
| Demo | Description |
|---|---|
| [`0.15.0-core-loop-demo`](0.15.0-core-loop-demo/) | **The game (current release target).** One-link room invites (room-key-first tickets, always-bridge imports, autogenerated dial hints) plus the local-node CORS/connect fixes; inherits all prior lines' improvements. |
...
[`0.15.0-core-loop-demo/src-tauri`](0.15.0-core-loop-demo/src-tauri/) (window, Rust
