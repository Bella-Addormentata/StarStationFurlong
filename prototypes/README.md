...
| Demo | Description |
|---|---|
| [`0.16.0-core-loop-demo`](0.16.0-core-loop-demo/) | **The game (current release target).** Mainline-DHT node discovery (zero servers/DNS/registration), auto-spawned sovereign `ssf-p2p-node` (embedded iroh-less listener demoted to labelled fallback), restored UPnP/NAT-PMP/PCP portmapper; inherits all prior lines' improvements. |
...
[`0.16.0-core-loop-demo/src-tauri`](0.16.0-core-loop-demo/src-tauri/) (window, Rust
